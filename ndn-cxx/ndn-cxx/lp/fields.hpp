...
typedef FieldDecl<field_location_tags::Header,
                          uint64_t,
                          tlv::SpeedTag> SpeedTagField;
BOOST_CONCEPT_ASSERT((Field<SpeedTagField>));

typedef FieldDecl<field_location_tags::Header,
                          uint64_t,
                          tlv::PriorityTag> PriorityTagField;
BOOST_CONCEPT_ASSERT((Field<PriorityTagField>));

typedef FieldDecl<field_location_tags::Header,
                          uint64_t,
                          tlv::SINRTag> SINRTagField;
BOOST_CONCEPT_ASSERT((Field<SINRTagField>));
// Atif-Code End
