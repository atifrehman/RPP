...
/** \class SpeedTag
 *  \brief a packet tag for SpeedTag field
 *
 * This tag can be attached to Interest, Data, Nack.
 */
typedef SimpleTag<uint64_t, 0x60000002> SpeedTag;


/** \class PriorityTag
 *  \brief a packet tag for PriorityTag field
 *
 * This tag can be attached to Interest, Data, Nack.
 */
typedef SimpleTag<uint64_t, 0x60000003> PriorityTag;

// Atif-Code: End


/** \class SINRTag
 *  \brief a packet tag for SINRTag field
 *
 * This tag can be attached to Interest, Data, Nack.
 */
typedef SimpleTag<uint64_t, 0x60000004> SINRTag;
