...
//Atif-Code:  setting location tag
  std::tuple<double,double,double> pos={29.81,71.32,36.123};
  lp::GeoTag geoTag(pos);
  interest->setTag<lp::GeoTag>(std::make_shared<lp::GeoTag>(geoTag));

//Atif-Code: setting location tag end 

//Atif-Code:  setting speed tag
  
  interest->setTag<lp::SpeedTag>(std::make_shared<lp::SpeedTag>(50));

//Atif-Code: setting speed tag end 

//Atif-Code:  setting speed tag
  
  interest->setTag<lp::PriorityTag>(std::make_shared<lp::PriorityTag>(1));

//Atif-Code: setting speed tag end 

//Atif-Code:  setting speed tag
  
  interest->setTag<lp::SINRTag>(std::make_shared<lp::SINRTag>(24));
